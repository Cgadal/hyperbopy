...
def F(W_int, g, r):
    return np.swapaxes(np.array([W_int[1, ...],
                                W_int[1, ...]**2/W_int[0, ...] + g *
                                 ...
                                 W_int[3, ...],
                                W_int[3, ...]**2/(W_int[2, ...] - W_int[4, ...]) + (g/2)*(
                                    W_int[2, ...]**2 - r*W_int[1, ...]**2) - g*(r*W_int[1, ...] + W_int[2, ...])*W_int[4, ...]
                                 ]),
                       0, 1)
...
#     #
#     var_m_int = var[:, 1:-1] + dx/2*var_x
#     var_p_int = var[:, 2:] - dx/2*var_x
...
def Variables_int(var, dx, theta):
    ...
    #
    var_m_int = var[:, 0:-1] + dx/2*var_x[:, 0:-1]
